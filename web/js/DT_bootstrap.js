/*
 * Core File:   jquery.dataTables.min.js
 * Version:     1.9.4
...
$.extend(!0, $.fn.dataTable.defaults, {sDom: "<'row-fluid'<'span6'l><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>", sPaginationType: "bootstrap", oLanguage: {sLengthMenu: "_MENU_ records per page"}});
...
$.extend($.fn.dataTableExt.oPagination, {bootstrap: {fnInit: function (b, e, c) {
            ...
            $(e).addClass("pagination").append('<ul><li class="prev disabled"><a href="#">&larr; ' + d.sPrevious + '</a></li><li class="next disabled"><a href="#">' + d.sNext + " &rarr; </a></li></ul>");
            e = $("a", e);
            $(e[0]).bind("click.DT", {action: "previous"}, a);
            $(e[1]).bind("click.DT", {action: "next"}, a)
        }, fnUpdate: function (b, e) {
            var c = b.oInstance.fnPagingInfo(), d = b.aanFeatures.p, a, g, k, f, h;
            a = Math.floor(2.5);
            ...
            for (iLen = d.length; a < iLen; a++) {
                ...
                for (g = f; g <= h; g++)
                    k = g == c.iPage + 1 ? 'class="active"' : "", $("<li " + k + '><a href="#">' + g + "</a></li>").insertBefore($("li:last", d[a])[0]).bind("click", function (a) {
                        a.preventDefault();
